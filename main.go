...
func main() {
	...
	console.Commands = map[string]cli.CommandFactory{
		...
		"orders": func() (cli.Command, error) {
			return &command.OrdersCommand{CommandMeta: &cm}, nil
		},
		"ticker": func() (cli.Command, error) {
			return &command.TickerCommand{CommandMeta: &cm}, nil
		},
